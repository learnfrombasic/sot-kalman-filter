...
from src.vendors.pysot.datasets.anchor_target import AnchorTarget
from src.vendors.pysot.datasets.augmentation import Augmentation
from src.vendors.pysot.utils.bbox import Center, center2corner

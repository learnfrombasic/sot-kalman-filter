...
from src.vendors.pysot.core.xcorr import xcorr_depthwise
from src.vendors.pysot.models.head.rpn import DepthwiseXCorr
...
class MaskCorr(DepthwiseXCorr):
    def __init__(
        ...
        super(MaskCorr, self).__init__(
            in_channels, hidden, out_channels, kernel_size, hidden_kernel_size
        )
